            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="{{URL::to('/voiture-dispo')}}" class="nav-item nav-link">Voitures Disponibles</a>
                        @if (auth()->user())
                            @if (auth()->user()->admin == 1)
                            <a href="{{URL::to('/dashboard')}}" class="nav-item nav-link">Admin</a>
                            @endif
                        <a href="{{URL::to('/mes-locations')}}" class="nav-item nav-link">Mes Locations</a>
                        <a href="{{URL::to('/logout')}}" class="nav-item nav-link">Se deconnecter</a>
                        @else
                        <a href="{{URL::to('/login')}}" class="nav-item nav-link">Se connecter</a>
                        @endif
